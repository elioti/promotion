# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-03-16 05:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.IntegerField(unique=True, verbose_name='分类')),
            ],
            options={
                'verbose_name': '奖品管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prizeId', models.IntegerField(default=None, verbose_name='奖品ID')),
                ...
                ('isSend', models.IntegerField(choices=[(0, '未派送'), (1, '已派送')], default=0, verbose_name='是否发送')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.CharField(max_length=32, verbose_name='活动用户')),
                ('sequence', models.CharField(default='', max_length=64, verbose_name='顺序')),
                ...
                ('type', models.IntegerField(default=0, verbose_name='类别')),
            ],
            options={
                'verbose_name': '用户设定',
